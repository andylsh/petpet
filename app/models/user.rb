class User < ApplicationRecord
	...
	validates :phone_number, presence: true, numericality: { only_integer: true }, format: {with: /\d{10}/, message: "Please enter valid phone number"}
	...
	validates :password, length: {in: 4..8, too_short: "Minimum characters is 4", too_long: "Maximum characters is 8"}, allow_nil: true
